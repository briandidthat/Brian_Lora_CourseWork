...
public class NimComputer {
    ...
    public static void playGame() {
        ...
        while (a > 0 || b > 0 || c > 0) {
            ...
            while ( mod > 1)
            {
                if ((atemp % mod) == 0) { System.out.print("\n\t*"); atemp --; } else {System.out.print("\n\t ");}
                if ((btemp % mod) == 0) { System.out.print("*"); btemp --; } else {System.out.print(" ");}
                if ((ctemp % mod) == 0) { System.out.print("*"); ctemp --; } else {System.out.print(" ");}
                mod --;
            }
            System.out.print("\n\tABC");

            //change current player
            if (cp.equals(p1)) { cp = p2; System.out.print("\n\n" + p2 + ", pick a pile: "); }
            else { cp = p1; System.out.print("\n\n" + p1 + ", Pick a pile: "); }
