...
* Write a program that allows two human players to play Nim against each other. The program should detect when
* the last counter has been taken and declare a winner.
*/
public class Nim {
